  ...
  return (
    <div className="flex flex-col justify-center px-6 lg:px-8 h-[80vh]">
      <div className="mx-auto w-full max-w-sm">
        <div className="text-blue-800 text-center text-2xl font-semibold">
          FoodieMap
        </div>
      ...
      <div className="mt-10 mx-auto w-full max-w-sm">
        <div className="flex flex-col gap-3">
          <button
            ...
            className="text-black border border-gray-400 flex gap-2 bg-white hover:bg-gray-100/80 font-medium rounded-lg w-full px-5 py-4 text-center items-center justify-center"
          >
